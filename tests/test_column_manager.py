...
def test_column_manager_list_move_and_reset():
    ...
    assert reset["preferences"]["visible"] == ["macFormatted", "oui", "vendor", "model", "ip", "address", "room", "smartroomId", "switchIp", "switchPort", "authenticationTime", "hostname", "serialNumber", "deviceId", "deviceName", "source"]
