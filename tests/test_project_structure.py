...
def test_project_structure_and_maintenance_commands_exist():
    required = (
        ...
        "tests/frontend_dashboard_change_tabs.test.js",
        ...
        "tests/frontend_local_analytics.test.js",
    ...
    assert '$packageName = "MAC-Analyzer-$Version-Full-History"' in legacy_release_build
