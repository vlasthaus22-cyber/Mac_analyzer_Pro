...
(async () => {
  ...
  assert.strictEqual(report.ipHistory.length, 1);
  ...
  assert.strictEqual(performanceReport.snapshots[0].total, 10001, "device identity must be Smartroom ID + MAC");
  assert.strictEqual(performanceReport.skipped, 1, "rows without Smartroom ID are skipped and counted");
