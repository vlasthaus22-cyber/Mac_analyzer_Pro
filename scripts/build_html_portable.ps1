...
$scripts = @(
    ...
    "frontend/record-validation.js",
    "frontend/device-identity.js",
    "frontend/column-presets.js",
    "frontend/enrichment-strategy.js",
    "frontend/browser-snapshot-store.js",
    "frontend/time-utils.js",
    "frontend/mac-chronology.js",
    "frontend/presence-churn.js",
    "frontend/local-analytics.js",
...
foreach ($marker in @(
    ...
    "window.MacAnalyzerBatchEnrichment",
    "window.MacAnalyzerWorkspaceFileLifecycle",
    "window.MacAnalyzerEnrichmentStrategy",
    "window.MacAnalyzerColumnPresets",
    "window.MacAnalyzerPresenceChurn",
