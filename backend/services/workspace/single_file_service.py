...
FIELDS = ["mac", "secondaryMac", "vendor", "model", "deviceType", "ip", "address", "room", "smartroomId", "switchIp", "switchPort", "authenticationTime", "hostname", "serialNumber", "deviceId", "deviceName"]
