...
Для переноса состояния в другой браузер или на другой компьютер откройте
`Файловая база`, создайте файл `mac-analyzer-data.madb`, а в другом браузере
подключите этот же файл. MADB записывается и читается последовательно небольшими
...
выбирает файл базы вручную в каждом новом браузере; HTML не может самовольно
открыть произвольный локальный файл.
